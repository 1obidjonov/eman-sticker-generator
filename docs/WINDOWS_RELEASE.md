...
```text
release/Eman-Sticker-Generator-0.8.0-rc.1-x64.exe
```
...
```text
release/Eman-Sticker-Generator-Portable-0.8.0-rc.1-x64.exe
```
...
```powershell
Get-AuthenticodeSignature .\release\Eman-Sticker-Generator-0.8.0-rc.1-x64.exe
```
...
```powershell
Get-FileHash .\release\Eman-Sticker-Generator-0.8.0-rc.1-x64.exe -Algorithm SHA256
```
